...
class Transaction(models.Model):
    buyer = models.ForeignKey(CustomUser, related_name='bought_product', on_delete=models.CASCADE)
    seller = models.ForeignKey(CustomUser, related_name='sold_product', on_delete=models.CASCADE)
    product = models.ForeignKey(Product, on_delete=models.CASCADE)
    delivery_date = models.DateTimeField()
    deliver_fee = models.CharField(max_length=20)
    deliver_address = models.ForeignKey(Address, related_name="delivered_product", on_delete=models.CASCADE)
